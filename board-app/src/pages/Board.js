...
import { Button, Container, Grid, keyframes, TextField, Typography } from '@mui/material';
...
const Board = () => {
    ...
    const openAddFileInput = () => {
        ...
        const modify = useCallback (async (formData) => {
            try{
                const response = await axios.patch('http://localhost:9090/boards', formData, {
                    headers: {
                        Authorization: `Bearer ${sessionStorage.getItem('ACCESS_TOKEN')}`
                    }
                });
    ...
    <Container maxWidth='md' style={{marginTop: '3%', textAlign: 'center'}}>
        ...
        <form onSubmit={handlemodify}>
            ...
            <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                ...
                <Grid item
                    ...
                    <TextField name='title'
                               ...
                               aria-readonly = {board != null && loginMemberId !== board.writer_id ? 'true' : 'false'} // redux에 저장된 loginMemberId와 board.writer_id가 다르면 true, 같으면 false
            ...
            <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                ...
                <Grid item
                    ...
                    <TextField name='nickname'
                               ...
                               required
                               aria-readonly='true'
                               value={board != null ? board.nickname : true}
                               onChange={changeTextField}></TextField>
                </Grid>
            </Grid>
            <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                ...
                <Grid item
                    ...
                    <TextField name='content'
                               ...
                               aria-readonly={board != null && loginMemberId != board.writer_id ? 'true' : 'false'}
                               onChange={changeTextField}></TextField>
                </Grid>
            </Grid>
            <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
            ...
            <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                ...
                <Grid item
                      xs={10}>
                    <Button type='button' variant='outlined' onClick={openAddFileInput}>파일 선택</Button>
                    <input type='file'
                           multiple
                           name='uploadFiles'
                           id='uploadFiles'
                            ...
                            >
                                ...
                                <img width='150px'
                                     ...
                                     src={boardFile.filetype === 'image' 
                                        ? `https://kr.object.ncloudstorage.com/bitcamp119/${boardFile.filepath}${boardFile.filename}` 

...
public class TodoController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> removeTodo(@PathVariable("id") Long id, @AuthenticationPrincipal CustomUserDetails customUserDetails) { // @RequestParam : 파라미터를 받을 때, @PathVariable : url path로 받을 때
        ResponseDto<TodoDto> responseDto = new ResponseDto<>();
    ...
    @PatchMapping
    public ResponseEntity<?> modifyTodo(@RequestBody TodoDto todoDto, @AuthenticationPrincipal CustomUserDetails customUserDetails) {
        ResponseDto<TodoDto> responseDto = new ResponseDto<>();
